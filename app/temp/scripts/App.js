...
var _bars = __webpack_require__(105);
...
var BarFinder = {
  ...
  init: function init() {
    ...
    startBtn.addEventListener('click', function () {
      ...
      _Question2.default.insert.call(BarFinder.topics[0]);
    });

    // Set matches to full list of bars
    this.matches = [].concat(_toConsumableArray(_bars2.default.bars));
  ...
  generateTopicDetails: function generateTopicDetails() {
    var _this = this;

    var topicDetails = this.questionTopics.map(function (topic) {
      var name = topic,
          template = __webpack_require__(53)("./" + topic + '.hbs');
      var options = _this.matches.map(function (bar) {
        return bar[topic];
      });
      // Remove duplicates and sort alphabetically
      options = Array.from(new Set(options)).sort();
      var topicDetails = { name: name, options: options, template: template };
      return topicDetails;
    });
    return topicDetails;
  }
...
var _Elements = __webpack_require__(54);
...
var Results = {
  ...
  showMatches: function showMatches(matches) {
    var results = document.querySelector('.results'),
        resultsTemplate = __webpack_require__(49);
    var context = void 0,
        barDetails = void 0;
    var html = matches.map(function (bar) {
      context = {
        name: bar.name,
        website: bar.website,
  ...
  initMap: function initMap(matches) {
    var locations = matches.map(function (bar) {
      var loc = {};
  ...
  setupRestart: function setupRestart() {
    ...
    restartBtn.addEventListener('click', function () {
      ...
      _Question2.default.insert.count = 0;
    });
  },
  display: function display(matches) {
...
var Question = {
  ...
  checkInsertCount: function checkInsertCount() {
    var numOfTopics = _App2.default.topics.length;
  ...
  events: function events(name) {
    var options = Array.from(document.querySelectorAll('.' + name));
    options.forEach(function (option) {
      option.addEventListener('change', function () {
        // Update matches based on selected option
        _App2.default.updateMatches.call(this);
        if (Question.checkInsertCount()) {
          // If there are more topics, insert next question
          Question.insert.call(_App2.default.topics[Question.insert.count]);
        } else {
          // After the last question, display the matched bars
          _Results2.default.display(_App2.default.matches);
        }
      });
    });
  }
...
module.exports = __webpack_require__(8).String.includes;
...
var isObject = __webpack_require__(3)
  ...
  , MATCH    = __webpack_require__(0)('match');
module.exports = function(it){
  var isRegExp;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(70).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div>\r\n        <input class=\"drink\" name=\"drink\" type=\"radio\" id=\"radio-"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div>\r\n        <input class=\"neighborhood\" name=\"neighborhood\" type=\"checkbox\" id=\"checkbox-"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div>\r\n        <input class=\"tv\" name=\"tvOptions\" type=\"radio\" id=\"radio-tv-"
    + alias2(alias1(depth0, depth0))
    + "\" value=\""
    + alias2(alias1(depth0, depth0))
  ...
  return "<p class=\"question__text\">Should there be any TVs in the bar?</p>\r\n<div class=\"tv-choices\">\r\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.options : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    <div>\r\n        <input class=\"tv\" name=\"tvOptions\" type=\"radio\" id=\"radio-tv-maybe\" value=\"maybe\" />\r\n        <label class=\"tv-label\" for=\"radio-tv-maybe\">maybe</label>\r\n    </div>\r\n</div>\r\n";
},"useData":true});
